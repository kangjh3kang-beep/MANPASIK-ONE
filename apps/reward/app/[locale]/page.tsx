...
import { Database, Coins, Gift, TrendingUp, Clock, Star, ArrowUpRight } from 'lucide-react';
...
export default function RewardPage() {
  ...
  return (
    <>
      <DomainNav currentDomain="reward" />
      ...
      <div className="border-b border-slate-200 bg-white px-8 py-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900">환자 리워드 풀</h1>
        </div>
        <p className="text-sm text-slate-500">개인 건강 데이터 기여에 대한 투명한 보상 시스템</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 space-y-8">
        ...
        <div className="rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 p-8 text-white">
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <span className="text-sm">이번 주 +650 MPS 적립</span>
          </div>
        </div>
