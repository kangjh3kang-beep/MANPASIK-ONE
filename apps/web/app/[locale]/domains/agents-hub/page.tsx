    ...
    <main className="min-h-screen bg-slate-50" aria-label="AI 분석 센터">
      ...
      <section aria-label="관련 도메인" className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[{ name: "생체 예측", path: "/domains/predictor", desc: "GNN 예측 모델" },{ name: "하드웨어 코어", path: "/domains/hardware-core", desc: "Edge AI 엔진" },{ name: "임상 콘솔", path: "/domains/clinical", desc: "환자 바이탈 모니터링" }].map(d => (
