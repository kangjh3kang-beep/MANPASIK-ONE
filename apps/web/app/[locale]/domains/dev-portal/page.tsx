  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="border-b border-slate-200 bg-white px-8 py-6">
        <div className="flex items-center gap-3 mb-2"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800 text-white"><FileCode2 className="h-5 w-5" /></div><h1 className="text-2xl font-bold text-slate-900">개발자 포털</h1></div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 space-y-8">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-3">
            ...
            <button onClick={() => { navigator.clipboard.writeText(apiKey); setCopied(true); setTimeout(() => setCopied(false), 2000); }} className="text-slate-400 hover:text-white transition-colors">
