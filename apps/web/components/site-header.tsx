        ...
        <div className="flex items-center gap-12">
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-[22px] font-bold tracking-tight text-slate-900">
              MMUP<span className="text-sky-600">.</span> [SYNC_OK_11:15]
            </span>
          </Link>

          {/* Desktop Navigation Links */}
          <nav className="hidden lg:flex items-center gap-8">
            <Link href="/domains/agents-hub" className="text-[15px] font-semibold text-slate-600 hover:text-sky-600 transition-colors">솔루션 허브</Link>
            <Link href="/domains/hardware-core" className="text-[15px] font-semibold text-slate-600 hover:text-sky-600 transition-colors">하드웨어 코어</Link>
            <div className="h-4 w-px bg-slate-300"></div>
            <Link href="/domains/partner" className="text-[15px] font-semibold text-slate-600 hover:text-sky-600 transition-colors">파트너 연동</Link>
          </nav>
